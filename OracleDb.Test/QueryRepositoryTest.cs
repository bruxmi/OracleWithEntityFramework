...
using OracleDb.Core.Entities;
using OracleDb.Core.Enums;
using OracleDb.Core.Interfaces.Repository.Command;
using OracleDb.Core.Interfaces.Repository.Query;
using OracleDb.Repository;
using OracleDb.Repository.Command;
using OracleDb.Repository.Query;
using OracleDb.Test;
using System;
...
namespace OracleDb.Test
{
    public class QueryRepositoryTest : IClassFixture<DatabaseFixture>, IDisposable
    {
        ...
        public DevContext DbContext { get; set; }
        ...
        private void Init(DatabaseFixture data)
        {
            ...
            CourseQueryRepository = new QueryRepository<Course>(new RepositoryDevContextInitializer<Course>(this.DbContext));
            Initialized = true;
        }
